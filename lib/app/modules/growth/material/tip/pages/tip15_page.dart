      ...
      body: Container(
        ...
        child: ListView(children: <Widget>[
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                  fit: BoxFit.fill, image: AssetImage('images/ballon9.png')),
            ),
            child: regText(
                '\u25CF Movimento',
                '-  deverá experimentar '
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                  fit: BoxFit.fill, image: AssetImage('images/ballon91.png')),
            ),
            child: regText(
                '\u25CF Som',
                'Converse com sempre que estiver '
