...
mixin _$LgStore on _LgStoreBase, Store {
  late final _$faseAtom = Atom(name: '_LgStoreBase.fase', context: context);
  ...
  late final _$answersAtom =
      Atom(name: '_LgStoreBase.answers', context: context);
  ...
  late final _$uidAtom = Atom(name: '_LgStoreBase.uid', context: context);
  ...
  late final _$characterAtom =
      Atom(name: '_LgStoreBase.character', context: context);
  ...
  late final _$qtdRespSimAtom =
      Atom(name: '_LgStoreBase.qtdRespSim', context: context);
  ...
  late final _$qtdRespNaoAtom =
      Atom(name: '_LgStoreBase.qtdRespNao', context: context);
  ...
  late final _$qtdRespParAtom =
      Atom(name: '_LgStoreBase.qtdRespPar', context: context);
  ...
  late final _$qtdRespRecAtom =
      Atom(name: '_LgStoreBase.qtdRespRec', context: context);
  ...
  late final _$answerAtom = Atom(name: '_LgStoreBase.answer', context: context);
  ...
  late final _$simAtom = Atom(name: '_LgStoreBase.sim', context: context);
  ...
  late final _$indexAtom = Atom(name: '_LgStoreBase.index', context: context);
  ...
  late final _$naoAtom = Atom(name: '_LgStoreBase.nao', context: context);
  ...
  late final _$parcialAtom =
      Atom(name: '_LgStoreBase.parcial', context: context);
  ...
  late final _$recusaAtom = Atom(name: '_LgStoreBase.recusa', context: context);
  ...
  late final _$recoverDataAsyncAction =
      AsyncAction('_LgStoreBase.recoverData', context: context);
