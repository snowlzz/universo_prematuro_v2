...
mixin _$MgStore on _MgStoreBase, Store {
  late final _$faseAtom = Atom(name: '_MgStoreBase.fase', context: context);
  ...
  late final _$answersAtom =
      Atom(name: '_MgStoreBase.answers', context: context);
  ...
  late final _$uidAtom = Atom(name: '_MgStoreBase.uid', context: context);
  ...
  late final _$characterAtom =
      Atom(name: '_MgStoreBase.character', context: context);
  ...
  late final _$qtdRespSimAtom =
      Atom(name: '_MgStoreBase.qtdRespSim', context: context);
  ...
  late final _$qtdRespNaoAtom =
      Atom(name: '_MgStoreBase.qtdRespNao', context: context);
  ...
  late final _$qtdRespParAtom =
      Atom(name: '_MgStoreBase.qtdRespPar', context: context);
  ...
  late final _$qtdRespRecAtom =
      Atom(name: '_MgStoreBase.qtdRespRec', context: context);
  ...
  late final _$answerAtom = Atom(name: '_MgStoreBase.answer', context: context);
  ...
  late final _$simAtom = Atom(name: '_MgStoreBase.sim', context: context);
  ...
  late final _$indexAtom = Atom(name: '_MgStoreBase.index', context: context);
  ...
  late final _$naoAtom = Atom(name: '_MgStoreBase.nao', context: context);
  ...
  late final _$parcialAtom =
      Atom(name: '_MgStoreBase.parcial', context: context);
  ...
  late final _$recusaAtom = Atom(name: '_MgStoreBase.recusa', context: context);
  ...
  late final _$recoverDataAsyncAction =
      AsyncAction('_MgStoreBase.recoverData', context: context);
