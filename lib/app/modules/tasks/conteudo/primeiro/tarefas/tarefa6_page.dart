                  ...
                  child: Column(
                    children: [
                      ...
                      textCTRST(
                        ...
                        stg3:
                            ' deixe ${store.controllerKidName.text} explorar o brinquedo com suas mãozinhas. Os brinquedos'
                            ' de diferentes texturas, pesos (grs), cores e formatos são '
                            'importantes para o estímulo do desenvolvimento.',
                      ),
                      textCTRST(
                          stg1:
                              '\u2055 Não oferecer brinquedos que gera risco a '
                      ...
                      textCTRST(
                        stg1:
                            '\u2055 Brinque com o pezinho dele/a e estimule ${store.controllerKidName.text} a '
                            'olhar e segurar o seu próprio pé.',
                      ),
                      textCTRST(
                          stg1:
                              '\u2055 Sempre que possível pegar bebe no colo e oferecer o afeto.'),
                      const SizedBox(
                        height: 15.0,
                      ),
                      textCTRST(
                        stg1:
                            '\u2055 Aproveite esse momento para estimular sorrisos e a '
                      ...
                      textCTRST(
                        stg1:
                            '\u2055 Vamos cantar e estimular todos os movimentos '
                            'corporais até agora explorados.',
                      ),
                      textCTRST(
                          stg1: '\u2055 ',
                          stg2:
                              'Parabéns! Estamos indo muito bem com o desenvolvimento de bebe.'),
                      // SizedBox(height: 15.0:0.0,),
                      textCTRST(
                        stg1:
                            '\u2055 Responda a qualquer tentativa de emissão de sons de ${store.controllerKidName.text}'
