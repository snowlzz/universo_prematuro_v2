            ...
            child: Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t2");
                      },
                      child: const Text(
                        "Tarefa 2",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t3");
                      },
                      child: const Text(
                        "Tarefa 3",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t4");
                      },
                      child: const Text(
                        "Tarefa 4",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t5");
                      },
                      child: const Text(
                        "Tarefa 5",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t6");
                      },
                      child: const Text(
                        "Tarefa 6",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t7");
                      },
                      child: const Text(
                        "Tarefa 7",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed('/conteudo/t8');
                      },
                      child: const Text(
                        "Tarefa 8 ",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Modular.to.pushNamed("/conteudo/t9");
                      },
                      child: const Text(
                        "Tarefa 9",
                        textAlign: TextAlign.center,
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => const PessoalSocialPage())));
                      },
                      child: const Text(
