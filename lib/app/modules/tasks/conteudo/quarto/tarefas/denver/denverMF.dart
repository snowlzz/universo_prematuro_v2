                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          DenverRadioMF(index: 14,text: 'Coloca um objeto menor dentro de outro? Exemplo: Soltar um brinquedo dentro de uma caneca.',fase: "MF"),
                          Image.asset('images-dev/mf-adap/B15 - color.jpg'),
                          DenverRadioMF(index: 15,text: 'Rabisca espontaneamente no papel?',fase: "MF"),
                          Image.asset('images-dev/mf-adap/B16 - color.jpg'),
                          DenverRadioMF(index: 16,text: 'Retira objeto pequeno? Exemplo: Retira brinquedo dentro de uma caneca ou panela.',fase: "MF"),
