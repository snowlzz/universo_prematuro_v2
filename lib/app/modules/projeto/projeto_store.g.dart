...
mixin _$ProjetoStore on _ProjetoStoreBase, Store {
  late final _$valueAtom =
      Atom(name: '_ProjetoStoreBase.value', context: context);
  ...
  late final _$_ProjetoStoreBaseActionController =
      ActionController(name: '_ProjetoStoreBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_ProjetoStoreBaseActionController.startAction(
        name: '_ProjetoStoreBase.increment');
    try {
